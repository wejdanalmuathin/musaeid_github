    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statBox}>
            {/* ✅ UPDATED */}
            <Text style={styles.statNumber}>{userData.years}</Text>
...
<View style={styles.section}>
  ...
  <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8 }}>
    {userData.skills.map((skill) => (
      <View key={skill} style={styles.tagPrimary}>
        <MaterialIcons name="build" size={16} color="#2E2A84" />
        <Text style={styles.tagPrimaryText}>{skill}</Text>
      </View>
    ))}
  </View>
</View>
...
<View style={styles.section}>
  ...
  <View style={styles.tagRow}>
    {Object.keys(userData.serviceAreas)
      .filter((area) => userData.serviceAreas[area])
      .map((area) => (
